...
//         {/* 👇 Important wrapper to block all touch events */}
...
//       {/* Login Container */}
//       <div className="relative z-50 w-full max-w-md p-10 border border-white/20 rounded-2xl backdrop-blur-md bg-transparent shadow-2xl text-center">
