          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-8">
              ...
              <p className="text-xl text-slate-400 max-w-xl leading-relaxed">
                Master the art of <span className="text-white capitalize">{video.category.toLowerCase()}</span> with professional-grade curriculum designed by <span className="text-white">{video.instructor}</span>. Gain the skills needed to excel in today's competitive market.
              </p>
              ...
              <div className="flex flex-wrap gap-8 text-slate-300 text-sm font-semibold pt-4">
                ...
                <div className="flex items-center gap-2.5">
                  <Award className="w-5 h-5 text-violet-500" /> Professional Certificate
                </div>
                <div className="flex items-center gap-2.5">
        ...
        <div className="grid lg:grid-cols-12 gap-10">
          ...
          <div className="lg:col-span-8 space-y-12">
            ...
            <div className="bg-white rounded-[3rem] p-10 md:p-14 shadow-xl shadow-slate-200/50 border border-slate-100">
              <h3 className="text-2xl font-bold text-slate-900 mb-8">What you'll learn in this masterclass</h3>
            ...
            <div className="space-y-6 px-4">
              <h2 className="text-3xl font-bold text-slate-900">About this course</h2>
              <div className="prose prose-slate max-w-none text-slate-600 text-lg leading-relaxed">
                <p>
                   {video.description || "Detailed curriculum content is being prepared for this session."}
                </p>
                <p className="mt-4">
                  This comprehensive program is designed to take you from a foundational understanding 
                  to an expert level. We focus on practical execution rather than just theory, 
                  ensuring you have a portfolio-ready project by the end of the masterclass.
                </p>
              </div>
            </div>
            ...
            <div className="space-y-6 pb-20">
               <div className="flex items-center justify-between px-4">
                  <h2 className="text-3xl font-bold text-slate-900">Masterclass Module</h2>
            ...
            <div className="sticky top-10 space-y-6 pb-10">
              <div className="bg-white p-10 rounded-[3rem] border border-slate-200 shadow-2xl shadow-slate-200/60">
                <div className="flex items-baseline gap-3 mb-8">
                  <span className="text-5xl font-black text-slate-900">₹{video.price}</span>
                  <span className="text-slate-400 line-through text-xl">₹{(parseInt(video.price) * 1.5).toFixed(0)}</span>
                </div>
              ...
              <div className="bg-gradient-to-br from-[#4F46E5] to-[#7C3AED] p-10 rounded-[3rem] text-white shadow-xl">
                ...
                <p className="text-white/80 text-sm mb-6 leading-relaxed">Get access to our private Discord with over 5,000+ creators and weekly live Q&A sessions.</p>
